...
import { icons, COLORS, SIZES, FONTS } from '../constents'
...
function RestaurantScreen({ route, navigation }) {
    ...
    function getBasketTotalCount() {
        let totalCount = orderItems.reduce((a, b) => a + (b.total || 0), 0);
        ...
        return (
            <View>
                ...
                >
                    ...
                    >
                        <Text style={{ ...FONTS.h3 }}>{getBasketItemCount()} Items on Cart</Text>
                        <Text style={{ ...FONTS.h3 }}>{getBasketTotalCount()}€</Text>
                    </View>
                    <View
                        style={{
                            flexDirection: 'row',
                    ...
                    >
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.padding, ...FONTS.h4 }}>xxx8888</Text>
                        </View>
                    </View>
